%function [pval, t_orig, seed_state]=mult_comp_perm_t1(data,n_perm,tail,mu,reports,seed_state)
%
...
% >> [pval, t_orig, seed_state]=mult_comp_perm_t1(data,50000);
...
% >> [pval, t_orig, seed_state]=mult_comp_perm_t1(dif,50000);
% >> disp(pval); %adjusted p-values
%
% References:
% Blair, R.C. & Karnisky, W. (1993) An alternative method for significance
